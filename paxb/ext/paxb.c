...
zend_class_entry *paxb_filter_filters_filterinterface_ce;
zend_class_entry *paxb_binding_structure_structureinterface_ce;
zend_class_entry *paxb_binding_metadata_factoryinterface_ce;
zend_class_entry *paxb_binding_metadata_metadatainterface_ce;
zend_class_entry *paxb_filter_filterinterface_ce;
zend_class_entry *paxb_filter_loaderinterface_ce;
zend_class_entry *paxb_binding_annotations_filter_annotationinterface_ce;
zend_class_entry *paxb_binding_annotations_loaderinterface_ce;
zend_class_entry *paxb_binding_annotations_xml_annotationinterface_ce;
zend_class_entry *paxb_filter_filters_objectawarefilter_ce;
zend_class_entry *paxb_filter_exception_filterexception_ce;
zend_class_entry *paxb_filter_filters_regexp_ce;
zend_class_entry *paxb_binding_structure_abstractstructure_ce;
zend_class_entry *paxb_filter_exception_ruleoptionsexception_ce;
...
zend_class_entry *paxb_binding_metadata_container_ce;
zend_class_entry *paxb_binding_metadata_exception_ce;
zend_class_entry *paxb_binding_metadata_factory_ce;
zend_class_entry *paxb_binding_metadata_metadata_ce;
zend_class_entry *paxb_filter_exception_invalidcallbackexception_ce;
zend_class_entry *paxb_filter_exception_invalidoptionsexception_ce;
zend_class_entry *paxb_filter_exception_invalidzendfilterexception_ce;
zend_class_entry *paxb_filter_exception_missingoptionsexception_ce;
zend_class_entry *paxb_filter_exception_ruledefinitionexception_ce;
zend_class_entry *paxb_filter_filter_ce;
zend_class_entry *paxb_filter_filters_alpha_ce;
zend_class_entry *paxb_filter_filters_alphanumeric_ce;
zend_class_entry *paxb_filter_filters_digits_ce;
zend_class_entry *paxb_filter_filters_htmlentities_ce;
zend_class_entry *paxb_filter_filters_integer_ce;
zend_class_entry *paxb_filter_filters_pregreplace_ce;
zend_class_entry *paxb_filter_filters_stripnewlines_ce;
zend_class_entry *paxb_filter_filters_striptags_ce;
zend_class_entry *paxb_filter_filters_tolower_ce;
zend_class_entry *paxb_filter_filters_trim_ce;
zend_class_entry *paxb_filter_filters_zend_ce;
zend_class_entry *paxb_filter_loader_ce;
zend_class_entry *paxb_filter_objectwalker_ce;
...
static PHP_MINIT_FUNCTION(paxb)
{
	...
	ZEPHIR_INIT(PAXB_Filter_Filters_FilterInterface);
	ZEPHIR_INIT(PAXB_Binding_Structure_StructureInterface);
	ZEPHIR_INIT(PAXB_Binding_Metadata_FactoryInterface);
	ZEPHIR_INIT(PAXB_Binding_Metadata_MetadataInterface);
	ZEPHIR_INIT(PAXB_Filter_FilterInterface);
	ZEPHIR_INIT(PAXB_Filter_LoaderInterface);
	ZEPHIR_INIT(PAXB_Binding_Annotations_Filter_AnnotationInterface);
	ZEPHIR_INIT(PAXB_Binding_Annotations_LoaderInterface);
	ZEPHIR_INIT(PAXB_Binding_Annotations_Xml_AnnotationInterface);
	ZEPHIR_INIT(PAXB_Filter_Filters_ObjectAwareFilter);
	ZEPHIR_INIT(PAXB_Filter_Exception_FilterException);
	ZEPHIR_INIT(PAXB_Filter_Filters_RegExp);
	ZEPHIR_INIT(PAXB_Binding_Structure_AbstractStructure);
	ZEPHIR_INIT(PAXB_Filter_Exception_RuleOptionsException);
	...
	ZEPHIR_INIT(PAXB_Binding_Metadata_Container);
	ZEPHIR_INIT(PAXB_Binding_Metadata_Exception);
	ZEPHIR_INIT(PAXB_Binding_Metadata_Factory);
	ZEPHIR_INIT(PAXB_Binding_Metadata_Metadata);
	ZEPHIR_INIT(PAXB_Filter_Exception_InvalidCallbackException);
	ZEPHIR_INIT(PAXB_Filter_Exception_InvalidOptionsException);
	ZEPHIR_INIT(PAXB_Filter_Exception_InvalidZendFilterException);
	ZEPHIR_INIT(PAXB_Filter_Exception_MissingOptionsException);
	ZEPHIR_INIT(PAXB_Filter_Exception_RuleDefinitionException);
	ZEPHIR_INIT(PAXB_Filter_Filter);
	ZEPHIR_INIT(PAXB_Filter_Filters_Alpha);
	ZEPHIR_INIT(PAXB_Filter_Filters_AlphaNumeric);
	ZEPHIR_INIT(PAXB_Filter_Filters_Digits);
	ZEPHIR_INIT(PAXB_Filter_Filters_HtmlEntities);
	ZEPHIR_INIT(PAXB_Filter_Filters_Integer);
	ZEPHIR_INIT(PAXB_Filter_Filters_PregReplace);
	ZEPHIR_INIT(PAXB_Filter_Filters_StripNewlines);
	ZEPHIR_INIT(PAXB_Filter_Filters_StripTags);
	ZEPHIR_INIT(PAXB_Filter_Filters_ToLower);
	ZEPHIR_INIT(PAXB_Filter_Filters_Trim);
	ZEPHIR_INIT(PAXB_Filter_Filters_Zend);
	ZEPHIR_INIT(PAXB_Filter_Loader);
	ZEPHIR_INIT(PAXB_Filter_ObjectWalker);
