...
ZEPHIR_INIT_CLASS(PAXB_Xml_Binding_Structure_Base) {
	...
	ZEPHIR_REGISTER_CLASS(PAXB\\Xml\\Binding\\Structure, Base, paxb, xml_binding_structure_base, paxb_xml_binding_structure_base_method_entry, 0);

	zend_declare_property_string(paxb_xml_binding_structure_base_ce, SL("name"), "", ZEND_ACC_PROTECTED TSRMLS_CC);

	zend_declare_property_long(paxb_xml_binding_structure_base_ce, SL("source"), 0, ZEND_ACC_PROTECTED TSRMLS_CC);

	zend_declare_class_constant_long(paxb_xml_binding_structure_base_ce, SL("GETTER_SOURCE"), 1 TSRMLS_CC);

	zend_declare_class_constant_long(paxb_xml_binding_structure_base_ce, SL("FIELD_SOURCE"), 2 TSRMLS_CC);
