...
ZEPHIR_INIT_CLASS(PAXB_Binding_Metadata_Metadata) {
	...
	ZEPHIR_REGISTER_CLASS(PAXB\\Binding\\Metadata, Metadata, paxb, binding_metadata_metadata, paxb_binding_metadata_metadata_method_entry, 0);

	/**
	 * @var string
	 */
	zend_declare_property_null(paxb_binding_metadata_metadata_ce, SL("className"), ZEND_ACC_PROTECTED TSRMLS_CC);

	/**
	 * @var string
	 */
	zend_declare_property_null(paxb_binding_metadata_metadata_ce, SL("name"), ZEND_ACC_PROTECTED TSRMLS_CC);

	/**
	 * @var array
	 */
	zend_declare_property_null(paxb_binding_metadata_metadata_ce, SL("attributes"), ZEND_ACC_PROTECTED TSRMLS_CC);

	/**
	 * @var Element[]
	 */
	zend_declare_property_null(paxb_binding_metadata_metadata_ce, SL("elements"), ZEND_ACC_PROTECTED TSRMLS_CC);

	/**
	 * @var string
	 */
	zend_declare_property_null(paxb_binding_metadata_metadata_ce, SL("valueElement"), ZEND_ACC_PROTECTED TSRMLS_CC);

	/**
	 * Properties that contain filtering rules
	 * @var array
	 */
	zend_declare_property_null(paxb_binding_metadata_metadata_ce, SL("filteredProperties"), ZEND_ACC_PROTECTED TSRMLS_CC);

	/**
	 * @var \ReflectionClass
	 */
	zend_declare_property_null(paxb_binding_metadata_metadata_ce, SL("reflection"), ZEND_ACC_PROTECTED TSRMLS_CC);

	zend_declare_class_constant_long(paxb_binding_metadata_metadata_ce, SL("RUNTIME_TYPE"), 1 TSRMLS_CC);

	zend_declare_class_constant_long(paxb_binding_metadata_metadata_ce, SL("DEFINED_TYPE"), 2 TSRMLS_CC);

	zend_class_implements(paxb_binding_metadata_metadata_ce TSRMLS_CC, 1, paxb_binding_metadata_metadatainterface_ce);
	return SUCCESS;
...
PHP_METHOD(PAXB_Binding_Metadata_Metadata, __construct) {
	...
	if (ZEPHIR_IS_STRING_IDENTICAL(className, "")) {
		...
		zephir_throw_exception_debug(_0, "paxb/binding/metadata/metadata.zep", 58 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}
...
PHP_METHOD(PAXB_Binding_Metadata_Metadata, getPropertyRules) {
	...
	zephir_array_fetch(&_2, _1, property, PH_NOISY | PH_READONLY, "paxb/binding/metadata/metadata.zep", 142 TSRMLS_CC);
	zephir_array_fetch_string(&_3, _2, SL("rules"), PH_NOISY | PH_READONLY, "paxb/binding/metadata/metadata.zep", 142 TSRMLS_CC);
	RETURN_CTOR(_3);
...
PHP_METHOD(PAXB_Binding_Metadata_Metadata, mergeRules) {
	...
	zephir_check_call_status();
	zephir_is_iterable(_0, &_2, &_1, 0, 0, "paxb/binding/metadata/metadata.zep", 172);
	for (
	  ...
	  ; zephir_hash_move_forward_ex(_2, &_1)
		...
		zephir_check_call_status();
		zephir_is_iterable(_4, &_6, &_5, 0, 0, "paxb/binding/metadata/metadata.zep", 170);
		for (
