...
ZEPHIR_INIT_CLASS(PAXB_Annotations_Annotation) {
	...
	ZEPHIR_REGISTER_CLASS(PAXB\\Annotations, Annotation, paxb, annotations_annotation, paxb_annotations_annotation_method_entry, 0);

	/**
	 * @var string
	 */
	zend_declare_property_null(paxb_annotations_annotation_ce, SL("value"), ZEND_ACC_PUBLIC TSRMLS_CC);
...
PHP_METHOD(PAXB_Annotations_Annotation, __construct) {
	...
	zephir_is_iterable(data, &_1, &_0, 0, 0, "paxb/annotations/annotation.zep", 34);
	for (
	  ...
	  ; zephir_hash_move_forward_ex(_1, &_0)
		...
		if (!(zephir_isset_property_zval(this_ptr, key TSRMLS_CC))) {
			...
			zephir_check_call_status();
			zephir_throw_exception_debug(_3, "paxb/annotations/annotation.zep", 29 TSRMLS_CC);
			ZEPHIR_MM_RESTORE();
			return;
		}
...
PHP_METHOD(PAXB_Annotations_Annotation, __get) {
	...
	zephir_check_call_status();
	zephir_throw_exception_debug(_0, "paxb/annotations/annotation.zep", 46 TSRMLS_CC);
	ZEPHIR_MM_RESTORE();
	return;
...
PHP_METHOD(PAXB_Annotations_Annotation, __set) {
	...
	ZEPHIR_CALL_METHOD(NULL, _0, "__construct", NULL, _3);
	zephir_check_call_status();
	zephir_throw_exception_debug(_0, "paxb/annotations/annotation.zep", 60 TSRMLS_CC);
	ZEPHIR_MM_RESTORE();
	return;
